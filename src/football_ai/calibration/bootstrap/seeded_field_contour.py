...
def build_seeded_field_contour(
    ...
    corners = (
        SeededFieldCorner("linksachter", (0.0, 0.0), left_rear, goal_a.frame_number, goal_a.rear_corner is not None),
        SeededFieldCorner("linksvoor", (0.0, pitch_width_m), left_front, goal_a.frame_number, goal_a.front_corner is not None),
        SeededFieldCorner("rechtsachter", (pitch_length_m, 0.0), right_rear, goal_b.frame_number, goal_b.rear_corner is not None),
        SeededFieldCorner("rechtsvoor", (pitch_length_m, pitch_width_m), right_front, goal_b.frame_number, goal_b.front_corner is not None),
    )
    return SeededFieldContour(profile.match_format.value, pitch_length_m, pitch_width_m, corners)
